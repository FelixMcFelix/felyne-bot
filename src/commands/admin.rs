...
#[owner_privilege]
pub async fn admin_ctl_mode(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
...
#[aliases("ctl-mode")]
#[owner_privilege]
pub async fn ctl_mode(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
